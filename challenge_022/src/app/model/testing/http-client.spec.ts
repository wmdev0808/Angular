...
describe('HttpClient testing', () => {
  ...
  it('can test HttpClient.get with matching header', () => {
    ...
    // Make a HTTP request with specific header
    httpClient
      .get<Data>(testUrl, {
  ...
  it('can test multiple requests', () => {
    ...
    httpClient
      .get<Data[]>(testUrl)
      .subscribe((d) =>
        expect(d.length).withContext('should have no data').toEqual(0)
      );
    ...
    httpClient
      .get<Data[]>(testUrl)
      .subscribe((d) =>
        expect(d).withContext('should be expected data').toEqual(testData)
      );
