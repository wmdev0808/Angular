...
describe("Command Runner Builder", () => {
  ...
  it("can run ls", async () => {
    ...
    // Stop the builder from running. This really stops Architect from keeping the builder associated states in memory, since builders keep waiting to be scheduled.
    await run.stop();

    // Expect that it succeeded.
    expect(output.success).toBe(true);

    // Expect that this file was listed. It should be since we're running `ls $__dirname`.
